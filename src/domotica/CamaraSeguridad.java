...
public class CamaraSeguridad extends DispositivoInteligente implements EmitirAlerta {
	...
	public String toString() {
		return "CamaraSeguridad: [ resolucion: " + resolucion + " | grabando: " + grabando + " | mensajeAlerta: " + mensajeAlerta
				+ " | nombreComercial: " + nombreComercial + " | marca: " + marca + " | encendido: " + encendido + " | precio: "
				+ precio + " ]";
	}
